...
<body>
  ...
  <nav>
    <a class="btn btn-primary btn-selected" style="font-size:30px;">Trenutno</a>
    <a class="btn btn-primary btn-other" style="font-size:30px;" href="statistika-ukupna.php">Ukupno</a>
    <a class="btn btn-primary btn-other dropdown-toggle" href="#" style="font-size:30px;"
...
<div class="container" align="center">
            <h1 class="text-center" style="font-family:Bungee; font-size: 50px;">Statistika</h1><br>
