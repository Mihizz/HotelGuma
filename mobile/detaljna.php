...
<html>
   ...
   <body>
      ...
      <button type="button" class="btn btn-primary btn-lg" title="Unesi gume u hotel" style="font-size:40px; color:#4CAF50;float: right; margin-right:20px;">Unesi u bazu</button></a>
      
      <div style="height: 80px;"></div>

      <div class="container1">
         <div class="row">
            <h2 class="text-center" style="font-family:Bungee">Detaljni prikaz</h2>
         </div>
         <div class="row">
            <div class="col-md-12">
               <?php
$sql    = "SELECT cuvanje.*, korisnik.ime, korisnik.mesto ,  mesto.mestoCelo FROM cuvanje 
                      ...
                      JOIN mesto ON mesto.idMesto = cuvanje.idMesto WHERE red='$redX' && kolona='$kolonaX'";
