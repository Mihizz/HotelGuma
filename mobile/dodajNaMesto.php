...
<html>
   ...
   <body>
      ...
      <a href="skica.php"
      <button type="button" class="btn btn-primary btn-lg" title="Vrati se nazada na hotel" style="font-size:40px; float: right; margin-right:20px;margin-top:20px;">Vrati se na SKICU</button></a>
      ...
      <div class="container">
                              ...
                              if ($date1 == ""){
                                 ...
                                 $daljeIde = 0;
            						...
            						if($result){
            							...
            							<h1>Kliknite ovde da se vratite na skicu: <a href='skica.php'>Skica baze</a></h1>
            							</div>";
         ...
         <form method="post">
            ...
            <label for="RowPlace" style="font-size: 50px;">Red</label> 
                  <input style="border:3px solid black; height:2.5em; font-size:50px;" class="form-control" id="RowPlace" name="RowPlace" value="<?php echo $redX?>" type="text" placeholder="npr. C" autocomplete="off" disabled>
               <div style="height:80px;"></div>
               <label for="ColumnPlace" style="font-size: 50px;">Kolona</label> 
                  <input style="border:3px solid black; height:2.5em; font-size:50px;" class="form-control" id="ColumnPlace" name="ColumnPlace" value="<?php echo $kolonaX?>" type="number" placeholder="npr. 6" autocomplete="off" disabled>
               <div style="height:80px;"></div>
               <label for="FloorPlace" style="font-size: 50px;">Sprat</label> 
                  <input style="border:3px solid black; height:2.5em; font-size:50px;" class="form-control" id="FloorPlace" name="FloorPlace" value="<?php echo $spratX?>" type="number" placeholder="npr. 3" autocomplete="off" disabled>
