...
$quer1 ="SELECT COUNT(idKorisnik) FROM korisnik WHERE datumUnosa LIKE '2021-%'";
...
$quer2 ="SELECT COUNT(idEvidencija) FROM evidencija WHERE datum LIKE '%-2021' && tipIzmene='DODATO'";
...
//ukupno guma u bazi
$quer3 ="SELECT SUM(kolicina) FROM evidencija WHERE datum LIKE '%-2021' && tipIzmene='DODATO'";
...
$quer4 = "SELECT korisnik.mesto, COUNT(korisnik.mesto) AS broj FROM korisnik WHERE datumUnosa LIKE '2021-%' GROUP BY mesto";  
$result4 = mysqli_query($con, $quer4);

$quer5 = "SELECT felna, COUNT(felna) AS broj1 FROM evidencija WHERE datum LIKE '%-2021' && tipIzmene='DODATO' GROUP BY felna";  
$result5 = mysqli_query($con, $quer5);

$quer6 = "SELECT SUBSTRING(gumaCelo, 9, 9) AS precnik, COUNT(SUBSTRING(gumaCelo, 9, 9)) AS broj2 FROM evidencija WHERE datum LIKE '%-2021' && tipIzmene='DODATO' GROUP BY precnik";  
...
<head>
   <title>Pocetna stranica</title>
      ...
      <title>Statistika 2021 | Hotel Stepic</title>
   ...
   <div class="logo">
	...
	<nav>
		...
		aria-haspopup="true" aria-expanded="false" style="font-size:30px;">Po godinama  <i class="fas fa-chevron-circle-down"></i></a>
			...
			<a class="btn btn-primary dropdown-item" style="padding:-5px; font-size:30px;" href="#">2021</a><br>
      <a class="btn dropdown-item" style="padding:-5px; font-size:30px;" href="statistika-2022.php">2022</a><br>
		</div>
	</nav> 
...
<div class="container" align="center">
            <h1 class="text-center" style="font-family:Bungee; font-size:45px;"><div style="text-decoration:underline;">Statistika </div><div style="font-size:35px;">2021 godina</div></h1><br>
      ...
      <br><br></div>
		<h2 class="text-center" style="font-family:Bungee;font-size:35px;"><div style="text-decoration:underline;">Detaljna pie tabala</div></h2>
		  <div class="row"> 
            <div class="col-xs-12 col-lg-4" align="center"> 
                <div id="piechart" style="width: 1000px; height: 900px;"></div> 
            </div>   
            <div class="col-xs-12 col-lg-4" align="center" style="margin-top: -100px;">  
                <div id="piechart1" style="width: 1000px; height: 900px;"></div>   
            </div> 
            <div class="col-xs-12 col-lg-4" align="center" style="margin-top: -100px;"> 
                <div id="piechart2" style="width: 1000px; height: 900px;"></div>  
                 </div> </div>     
</body>
</html>