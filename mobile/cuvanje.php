...
<html>
   ...
   <body>
      ...
      <button type="button" class="btn btn-primary btn-lg" title="Unesi gume u hotel" style="font-size:25px; color:#9192B7;float: right; margin-right:20px;margin-top:20px;">Unesi u bazu</button></a>
      <br><br>
