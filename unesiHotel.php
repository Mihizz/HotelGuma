      ...
      <div class="container">
         ...
         <form method="post">
            ...
            <div class="form-group row">
               ...
               <div class="col-xs-3 col-sm-2">
                  <input class="form-control" id="RowPlace" name="RowPlace" type="text" placeholder="npr. C" autocomplete="off">
               </div>
            </div>
            <div class="form-group row">
               ...
               <div class="col-xs-3 col-sm-2">
                  <input class="form-control" id="ColumnPlace" name="ColumnPlace" type="number" placeholder="npr. 6" autocomplete="off">
               </div>
            </div>
            <div class="form-group row">
               ...
               <div class="col-xs-3 col-sm-2">
                  <input class="form-control" id="FloorPlace" name="FloorPlace" type="number" placeholder="npr. 3" autocomplete="off">
               </div>
            </div>
            <div class="form-group row">
