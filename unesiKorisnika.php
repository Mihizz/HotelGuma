...
<html>
   <head>
      ...
      <title>Dodaj kupca | Hotel Stepic</title>
      ...
      <div class="container">
         <?php
            ...
            if($daljeIde === 1){
				$dateCurrent = date('Y-m-d');
            						...
            						if($result){
            							...
            							<h3>Uspesno ste se dodali korisnika.</h3>
            ...
            " .$gIme. "
            				...
            				?>
         <h2 style="font-family:Bungee; align-content:center;">Unos Korisnika u Bazu</h2>
         <br>
         <form method="post">
            <div class="form-group">
               <label for="disabledTextInput">Ime musterije</label>
               <input type="text" name="name" id="disabledTextInput" title="Ovde unesi ime musterije" class="form-control" placeholder="Npr. Marko Posta">
            </div>
            <br>
            <div class="form-group">
               <label for="disabledSelect">Prebivaliste musterije</label>
               <select id="disabledSelect" name="village" class="form-control" title="Unesi prebivaliste korisnika">
            ...
            <br>
            <center><button type="submit" name="submit" class="btn btn-success" title="Unesi korisnika u bazu" style="font-size: large;">Unesi korisnika</button></center>
         </form>
      </div>
   </body>
</html>