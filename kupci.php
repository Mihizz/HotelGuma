...
<html>
   <head>
      ...
      <title>Kupci | Hotel Stepic</title>
   ...
   <body>
	...
	<!-- unesi korisnika -->
      ...
      <button type="button" class="btn btn-primary btn-lg" title="Unesi novog korisnika u bazu" style="color:#4CAF50;float: right; margin-right:20px;">Unesi korisnika</button></a>
      <br><br>
      <div class="container">
         <div class="row">
