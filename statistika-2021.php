   ...
   <div class="logo">
	...
	<nav>
		...
		aria-haspopup="true" aria-expanded="false">Po godinama  <i class="fas fa-chevron-circle-down"></i></a>
			...
			<a class="btn btn-primary dropdown-item" style="padding:-5px;font-size:18px;" href="#">2021</a><br>
...
<div class="container" align="center">
            <h1 class="text-center" style="font-family:Bungee"><div style="text-decoration:underline;">Statistika </div><div style="font-size:25px;">2021 godina</div></h1><br>
