...
<html>
   <head>
      <title>Dobrodosli | Hotel Stepic</title>
      ...
      <style>
         body{
         background: url(pozadine/background.jpg);
    ...
    <body>
		<div class="container central">
			<div class="row">
			<div class="col-md-6">
					<img src="Logo.png" data-toggle="tooltip" alt="Logo.png"  width="450" height="210">
				</div>
	            <div class="col-md-6">
		...
		require 'config.php';
			...
			if (isset($_POST['email'])){
		        ...
		        if($rows == 1){
					...
					echo "<br><br><div class='alert alert-danger'><h3>Pogresna lozinka ili password</h3>
					<br><a href=\"login.php\">Pokusajte ponovo ?</div></div></div></div>";
